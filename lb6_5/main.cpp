...
template <size_t N> // Перегруженный оператор умножения
superlong<N> superlong<N>::operator*(const superlong<N>& s)const
{
    superlong<N> s1(*this);
    superlong<N> s2(s);
...
template <size_t N> // Статический метод представления 32х раз.числа в виде 16ричных цифр
...
template <size_t X> // Перегруженный оператор вывода, выводящий длинное число в 16ричном виде
